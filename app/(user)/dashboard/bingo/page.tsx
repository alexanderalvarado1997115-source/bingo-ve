...
export default function Dashboard() {
    ...
    const handleJoinGame = () => {
        if (tickets.length > 0 || gameState?.status === 'active') {
            // Si ya tiene tickets O el juego ya empezó (puede ver como espectador), entra
            setIsInLiveRoom(true);
        } else {
            // Si no tiene tickets y el juego no ha empezado, le vendemos
